...
本项目是一个基于 GitHub Actions 的自动化脚本，旨在利用 **DNSHE 免费域名 API**  实现子域名的自动续期，并通过 **Telegram Bot** 推送执行结果，确保您的免费域名永不过期。
...
| 变量名称               | 说明                 | 示例                |
| ------------------ | ------------------ | ----------------- |
| `API_KEY`    | DNSHE 的 API Key    | `cfsd_xxxxxxxxxx` |
| `API_SECRET` | DNSHE 的 API Secret | `yyyyyyyyyyyy`    |
| `TG_CHAT_ID`   | 接收ID     | `9a8b...`         |
| `TG_BOT_TOKEN`   | 机器人token | `123`             |
...
- [**Maritnbk/DNSHE-Auto-Renew**](https://github.com/Maritnbk/DNSHE-Auto-Renew)
